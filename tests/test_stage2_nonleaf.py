...
SAMPLE_RATE     = 4
RESOLUTION      = 320
FRAMES_PER_SEG  = 8     # frames sampled per segment (32 for production, 8 for speed)
...
prompt = "Describe what happens in this video sequence. Focus on the main actions and transitions."
results = []
